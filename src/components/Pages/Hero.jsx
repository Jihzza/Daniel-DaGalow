...
function Hero() {
  return (
    <section
      id="hero"
      className="text-white min-h-screen flex flex-col justify-center items-center text-center overflow-hidden"
    >
      <div className="w-full h-full px-4 overflow-visible">
        <img
          src={heroImage}
          alt="Hero"
          className="w-full h-full object-cover rounded-xl my-6 shadow-lg"
        />
        ...
        <div className="flex flex-col items-center justify-center gap-2">
          ...
          <p className="text-3xl font-extrabold mb-6">$120 / hour</p>
        </div>
        <a
          href="#booking"
