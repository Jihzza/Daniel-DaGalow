...
import rafael from "../../assets/img/Pessoas/Rafa.jpeg";
import gonçalo from "../../assets/img/Pessoas/Gonçalo.png";
  ...
  const testimonials = [
    {
      ...
      author: "Rafael M.",
      image: rafael, // Replace with actual image paths
    },
    {
        quote:
  ...
  return (
    <section id="testimonials" className="py-8 px-4 text-black overflow-hidden">
      <div className="max-w-3xl mx-auto text-center space-y-8 px-4 overflow-visible">
        ...
        <p className="text-lg">
          Here are some reviews and if I've ever helped you in real life, through my videos or any other way, leave a review, so I can help even more people. 
        </p>
        <Swiper
          modules={[Autoplay]}
          centeredSlides={true}
